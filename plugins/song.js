...
Trex.addrex({pattern: 'song ?(.*)', fromMe: true,  deleteCommand: true,  desc: Lang.ALIVE_DESC}, (async (message, match) => {
...
const link = match[1]
  ...
  {buttonId: 'MNU', buttonText: {displayText: 'Thanks 🎭 '+'\n\n THANKS FOR GIVING THIS VIDEO 🎭'}, type: 1},
 ]
...
const btn = {
    ...
    Trex.addrex({pattern: 'song ?(.*)', fromMe: false,  deleteCommand: true,  desc: Lang.ALIVE_DESC}, (async (message, match) => {
